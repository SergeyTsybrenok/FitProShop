  ...
  if (localStorage.getItem("productsLS") === null) {
    productsLocalStorage.value = [
      ...
      // 3
      {
        ...
        price: "3050",
        picture: "/FitProShop/../src/img/top3.jpg",
        gender: "Муж",
      },
      // 4
      {
      ...
      // 5
      {
        ...
        price: "5940",
        picture: "/FitProShop/../src/img/augustine-bk01.jpg",
        gender: "Муж",
      },
      // 6
      {
      ...
      // 8
      {
        ...
        price: "9240",
        picture: "/FitProShop/../src/img/011.png",
        gender: "Уни",
      },
      // 9
      {
      ...
      // 10
      {
        ...
        price: "4840",
        picture: "/FitProShop/../src/img/91954800-colby-leggings-gray-9.png",
        gender: "Жен",
      },
      // 11
      {
      ...
      // 12
      {
        ...
        price: "660",
        picture: "/FitProShop/../src/img/99178900-face-mask-01.jpg",
        gender: "Уни",
      },
      // 13
      {
        ...
        price: "7700",
        picture: "/FitProShop/../src/img/photo_5447243675500407571_y.png",
      ...
      // 14
      {
        ...
        price: "13640",
        picture: "/FitProShop/../src/img/photo_5447243675500407570_y.png",
