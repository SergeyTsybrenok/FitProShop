...
<template>
	...
	<header class="stickyHeader">
		...
		<nav class="nav" :class="{ open: isMenuOpen }">
			...
			<RouterLink :to="{ name: 'accountData' }" class="navBtnRoute">
				<button class="navBtn"
